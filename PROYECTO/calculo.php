...
for($x = 1; $x <= 5; $x++)
{
    ...
    if ($siquesi[0] > 0)
    {
        ...
        else
        {
            ...
            if(empty($sinotas)==false)
            {
            $var4 = "UPDATE eleccion SET Prioridad = '$y', Situacion = 'Dentro de la modalidad' where DNI = '$sinotas[0]'";
    ...
    if($siquesi[0] > 39)
    {
            ...
            else
        {
            ...
            if(empty($sinotas)==false)
            {
            $var4 = "UPDATE eleccion SET Prioridad = '$y', Situacion = 'En lista de espera' where DNI = '$sinotas[0]'";
            $conn4 = $conexion->query($var4); 
            }
        }
        }
