...
<head>
    ...
    <title>Lista de Modalidad</title>
                ...
                <ul class="nav" id="main-menu">
                    ...
                    <div class="preguntas" style="z-index:1">
                        ...
                        <div class="wrap-7">
                            ...
                            <label class="label" for="tab-7"><div>Modalidades</div><div class="cross"></div> </label>
                            <div class="questions">
                            <div class="question-wrap">
                            ...
                            <form action = "todoscursos.php" method = "post">
                                ...
                                <label for= "p" style="margin-left: 22%; font-size: 13px; color:#172d8d; cursor:pointer; cursor:pointer;">Todas las Modalidades</label>
                            </form>
                                </div>
                                </div>
...
if($siquesi[0] > 0)
{
    ...
    {   
        ...
        ?>
        <tr><td><?php echo $y?></td><td><?php echo $datos["Nombre"]?></td><td><?php echo $datos["PromediosT"]?></td><td><?php echo $datos["FichasT"]?></td><td><?php echo $datos["ObservacionesT"]?></td><td><?php echo $datos["InasistenciasT"]?></td><td ><?php echo $datos["Comentario"]?></td><td><?php echo $datos["mes"]?></td><tr><?php
    }
    else
        {
